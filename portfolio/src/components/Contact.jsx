...
const contatos = [
  {
    label: "Email",
    endereco: "andrade.gustavo37@gmail.com",
    href: "mailto:andrade.gustavo37@gmail.com",
    icon: (
      <svg
        ...
        {contatos.map((c, i) => (
          ...
          >
            ...
            <div className="info-textos">
              <p className="nome-contato">{c.label}</p>
              <p className="endereco">{c.endereco}</p>
            </div>
          </motion.a>
        ))}
      </div>
